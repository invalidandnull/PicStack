...
export default function ImageRestorer() {
  ...
  const [params, setParams] = useState<RestoreParams>(defaultParams);
      ...
      {!selectedImage && (
        ...
        >
          ...
          <h3 className="text-lg font-medium mb-2">
            {isDragging ? 'Drop your old photo here' : 'Drag & Drop your old photo here'}
          </h3>
          ...
          <div className="grid grid-cols-2 gap-8">
            ...
            <div className="space-y-2">
              <h3 className="text-sm font-medium text-gray-700">
                {processedImage ? 'Restored Photo' : 'Result Preview'}
              </h3>
              <div className="aspect-square relative border rounded-xl overflow-hidden">
                {processedImage ? (
                  <img
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                <input
                  type="checkbox"
                  id="color-enhance"
                  checked={params.color_enhance}
                  onChange={(e) => setParams({ ...params, color_enhance: e.target.checked })}
                  className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded"
                />
                <label htmlFor="color-enhance" className="text-sm font-medium text-gray-700">
                  Color Enhancement
                </label>
              </div>
            </div>
